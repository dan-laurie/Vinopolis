...
const Register = () => {
  ...
  return (
    ...
    <>
      ...
      <div className="orientation d-flex justify-content-center align-items-center">
        <div className="register">
          <Slide left>
            <div className="reg-info">
              <h2> Getting Started</h2>
              <p>In order to utilise all of Vinopolis&apos; features, please sign up for an account using the form!</p>
            </div>
          </Slide>
        </div>
          ...
          <div className="register-page">
            <div className="form-page">
              <div className="container">
                <div className="row">
                  <form onSubmit={handleSubmit} className="col-10 offset-1 mt-4 col-md-6 offset-md-3" style={{ width: 'fit-content' }}>
                    <h3>Sign Up</h3>
